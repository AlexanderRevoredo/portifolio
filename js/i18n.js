(() => {
    ...
    const translations = {
        pt: {
            ...
            "projects.fearQuiz.link": "Jogar agora",
            "projects.fearQuiz.linkLabel": "Jogar Fear Quiz (abre em uma nova aba)",
        ...
        en: {
            ...
            "projects.fearQuiz.link": "Play now",
            "projects.fearQuiz.linkLabel": "Play Fear Quiz (opens in a new tab)",
